...
X-Ray focuses on explaining *why* a pipeline produced an output, rather than
what code executed.

Instead of logging raw events or storing full candidate data, the system models
pipelines as a sequence of decision steps. Each step reports:
...
This enables fast diagnosis of failures in non-deterministic systems (e.g. LLM-
driven selection or ranking) without blocking execution or requiring full data
replay.
